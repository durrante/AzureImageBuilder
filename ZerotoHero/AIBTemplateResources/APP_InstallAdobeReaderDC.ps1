<#
.SYNOPSIS
    This script installs the latest version of Adobe Reader DC using the Evergreen PowerShell module.
...
.DESCRIPTION
    ...
    It will then use Evergreen to download the latest version of Adobe Reader DC and install it.
...
.EXAMPLE
    .\AVD_APP_InstallAdobeReaderDC.ps1
#>
...
Remove-Item -Path $AdobeReaderInstallerPath -Force -Recurse -ErrorAction SilentlyContinue
