...
Install-Application -url 'https://staiblcmuks00005.blob.core.windows.net/azureimagebuilder/Applications/vlc-3.0.18-win64.exe' -fileName 'vlc-3.0.18-win64.exe' -arguments @('/S')
